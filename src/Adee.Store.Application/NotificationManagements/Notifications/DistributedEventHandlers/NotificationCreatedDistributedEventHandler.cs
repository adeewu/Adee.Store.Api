...
using Adee.Store.NotificationManagement.Notifications.DistributedEvents;
using Volo.Abp.DependencyInjection;
using Volo.Abp.EventBus.Distributed;

namespace Adee.Store.NotificationManagement.Notifications.DistributedEventHandlers
{
    /// <summary>
    /// 创建消息事件处理
    /// </summary>

...
{
    public class IdenityServerApiResourceManager : StoreDomainService
    {
        ...
        {
            return _apiResourceRepository.GetListAsync("CreationTime desc", skipCount, maxResultCount, filter, includeDetails, cancellationToken);
        }
        ...
        public async Task<ApiResource> CreateAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            var apiResource = await _apiResourceRepository.FindByNameAsync(name.Trim(), false, cancellationToken);
            CheckHelper.IsNotNull(apiResource, "ApiResource已存在");
        ...
        {
            var apiResource = await _apiResourceRepository.FindByNameAsync(name.Trim(), true, cancellationToken);
            CheckHelper.IsNotNull(apiResource, "ApiResource已存在");
